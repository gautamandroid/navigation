...
import com.example.myarea.databinding.ProfileAdepterBinding
import com.example.myarea.modal.PostAdepterData


class PostAdapter(var context: Context, var onClick: OnItemClick) :
    ...
    class MyViewHolder(post: ProfileAdepterBinding) : RecyclerView.ViewHolder(post.root) {
        var bind = post
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var pos = ProfileAdepterBinding.inflate(LayoutInflater.from(context), parent, false)
